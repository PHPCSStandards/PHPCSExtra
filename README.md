...
* PHP 5.4 or higher.
* [PHP_CodeSniffer][phpcs-gh] version **3.13.6**/**4.0.2** or higher.
* [PHPCSUtils][phpcsutils-gh] version **1.2.3** or higher.
...
composer require --dev phpcsstandards/phpcsextra:"^1.5.0"
```
...
composer global require --dev phpcsstandards/phpcsextra:"^1.5.0"
```
